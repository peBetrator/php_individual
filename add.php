...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (checkValidity('heading') and
        ...
        if ($current_file != "assets/news_pictures/") {
            if (
                $_FILES["image"]["size"] <= 100000000 and
                (pathinfo($current_file, PATHINFO_EXTENSION) === "png" or pathinfo($current_file, PATHINFO_EXTENSION) === "jpg")
            ) {
